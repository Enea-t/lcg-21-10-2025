...
function meanOfAnArray(inputArr){
  let sum=0;
...
function draw() {
  ...
  // 1.C le deviazione standard, quanto variano e la dimensione
  mediaDimensioni = meanOfAnArray(stars_valid);
  text("media dimesioni stelle: " + mediaDimensioni.toFixed(2), 20, height/2 + 20 + 100);
